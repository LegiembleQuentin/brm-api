...
class Customer
{
    ...
    #[ORM\OneToMany(mappedBy: 'customer', targetEntity: Comment::class)]
    ...
    public function getLastCommand(): ?\DateTimeInterface
    {
        return $this->last_command;
    }

    public function setLastCommand(?\DateTimeInterface $last_command): static
    {
